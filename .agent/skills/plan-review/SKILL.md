...
```bash
bash "$Antigravity_PROJECT_DIR/.Antigravity/hooks/review-plan.sh" /tmp/plan_review_context.md
```
...
| 양쪽이 모순된 의견 | 실제 코드를 기준으로 Antigravity가 판단 |
...
- **패턴/규칙**: 프로젝트 Antigravity.md, rules/ 기준으로 확인
