...
|--------|------|-------------|----------|
| **PostgreSQL 17** | 변호사(17,326건), 법률용어(72,700건), 재판통계, 법령/판례 원본, 인제스트 21개 타입 원본, **BM25 FTS** (pg_textsearch, 425K건 search_text + BMW 최적화) | `USE_DB_LAWYERS`, `USE_LEGAL_TERM_DICT`, `USE_BM25_SEARCH` | `backend/CLAUDE.md` |
