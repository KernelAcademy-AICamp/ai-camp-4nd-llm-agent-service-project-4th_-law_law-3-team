...
- `ReferencePanel` - 법률 참조 패널 (references 도착 시 자동 오픈)
- `EvidencePanel` - 증거 표시 (물적 증거 + RAG 판례/법령 + 사용자 힌트 + 참조 판례/법령 접이식 섹션)
...
- `DemoStage` - 단계별 사용자 입력 + mock AI 응답 + 참조 판례/법령 (첫 단계부터 제공)
