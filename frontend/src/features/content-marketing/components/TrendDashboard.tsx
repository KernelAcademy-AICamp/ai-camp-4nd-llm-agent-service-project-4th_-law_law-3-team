...
import type { TrendFilters as TrendFiltersType, TrendIssue } from '../types'
...
export function TrendDashboard({ onGenerateScript }: TrendDashboardProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* 키워드 탐색 탭 */}
      {activeTab === 'keywords' && (
        <KeywordCollector onGenerateScript={onGenerateScript} />
      )}
